   ...
   (s = 0),
         ...
         o.$slides
            ...
            null !== o.$dots &&
               (o.$slides
                  ...
                  .each(function (e) {
                     ...
                     d(this).attr({
                        ...
                        -1 !== i &&
                           ((t = "slick-slide-control" + o.instanceUid + i),
                           d("#" + t).length &&
               ...
               o.$dots
                  ...
                  .end());
         for (
            var e = o.currentSlide, t = e + o.options.slidesToShow;
            e < t;
            e++
         )
      ...
      (r.prototype.lazyLoad = function () {
         ...
         function o(e) {
            d("img[data-lazy]", e).each(function () {
               var e = d(this),
                  ...
                  o =
                     d(this).attr("data-sizes") || n.$slider.attr("data-sizes"),
         ...
         if (
            ...
            for (
               var s = t - 1, r = i, l = n.$slider.find(".slick-slide"), a = 0;
            ...
            for (e in ((o.respondTo = o.options.respondTo || "window"), s))
               if (((i = o.breakpoints.length - 1), s.hasOwnProperty(e))) {
                  ...
                  o.breakpoints.push(t),
                     (o.breakpointSettings[t] = s[e].settings);
               }
            ...
            !0 === n.options.centerMode
               ? ((o = n.options.slidesToShow % 2 == 0 ? 1 : 0),
                 ...
                 !0 === n.options.infinite &&
                    ...
                    0 === e
                       ...
                       : e === n.slideCount - 1 &&
                         r.eq(n.options.slidesToShow).addClass("slick-center")),
               ...
               : ((i = n.slideCount % n.options.slidesToShow),
                 ...
                 n.slideCount - e < n.options.slidesToShow
                    ? r
                         .slice(t - (n.options.slidesToShow - i), t + i)
                         .addClass("slick-active")
                         .attr("aria-hidden", "false")
                    : r
      ...
      (r.prototype.swipeMove = function (e) {
         ...
         return (
            ...
            (r.touchObject.curX = void 0 !== l ? l[0].pageX : e.clientX),
            (r.touchObject.curY = void 0 !== l ? l[0].pageY : e.clientY),
            ...
            !r.options.verticalSwiping && !r.swiping && 4 < n
               ...
               : (!0 === r.options.verticalSwiping &&
                 ...
                 !1 === r.options.vertical
                    ? (r.swipeLeft = t + o * s)
                    : (r.swipeLeft =
                         t + o * (r.$list.height() / r.listWidth) * s),
         ...
         for (
            ...
            if (
               ("object" == typeof i || void 0 === i
                  ? (t[n].slick = new r(t[n], i))
                  : (e = t[n].slick[i].apply(t[n].slick, o)),
               void 0 !== e)
            )
               return e;
         return t;
   ...
   (function (e) {
      ...
      function u(e, t, i, o) {
         ...
         return (
            (s.className = "mfp-" + e),
            i && (s.innerHTML = i),
            o ? t && t.appendChild(s) : ((s = c(s)), t && s.appendTo(t)),
            s
         );
      }
      function f(e, t) {
      ...
      (e.prototype = {
         ...
         open: function (e) {
            if (!1 === e.isObj) {
               ...
               for (var t, i = e.items, o = 0; o < i.length; o++)
                  if (((t = i[o]).parsed && (t = t.el[0]), t === e.el[0])) {
                     m.index = o;
                     break;
                  }
            } else
            ...
            if (!m.isOpen) {
               (m.types = []),
                  ...
                  m.bgOverlay ||
                     ((m.bgOverlay = u("bg").on("click" + k, function () {
                        m.close();
                     })),
                     (m.wrap = u("wrap")
                        .attr("tabindex", -1)
               ...
               f("BeforeOpen"),
                  ...
                  m.fixedContentPos
                     ...
                     : m.wrap.css({ top: S.scrollTop(), position: "absolute" }),
                  (!1 !== m.st.fixedBgPos &&
                  ...
                  m.st.enableEscapeKey &&
                     g.on("keyup" + k, function (e) {
                        27 === e.keyCode && m.close();
                     }),
                  S.on("resize" + k, function () {
                     m.updateSize();
                  }),
               ...
               m.fixedContentPos &&
                  (!m._hasScrollBar(l) ||
                     ((r = m._getScrollbarSize()) && (a.marginRight = r))),
                  m.fixedContentPos &&
                     (m.isIE7
         ...
         updateItemHTML: function () {
            ...
            var t,
               i = e.type;
            f("BeforeChange", [m.currItem ? m.currItem.type : "", i]),
               (m.currItem = e),
               m.currTemplate[i] ||
                  ((t = !!m.st[i] && m.st[i].markup),
                  f("FirstMarkupParse", t),
                  (m.currTemplate[i] = !t || c(t))),
               s &&
                  s !== e.type &&
                  m.container.removeClass("mfp-" + s + "-holder");
            var o = m["get" + i.charAt(0).toUpperCase() + i.slice(1)](
               e,
               m.currTemplate[i]
            );
            m.appendContent(o, i),
         ...
         parseEl: function (e) {
            ...
            if (
               ...
               for (var o = m.types, s = 0; s < o.length; s++)
         ...
         addGroup: function (t, i) {
            ...
            ((i = i || {}).mainEl = t),
               i.items
                  ? ((i.isObj = !0), t.off(o).on(o, e))
                  : ((i.isObj = !1),
                    i.delegate
                       ? t.off(o).on(o, i.delegate, e)
                       : (i.items = t).off(o).on(o, e));
         },
         ...
         updateStatus: function (e, t) {
            ...
            m.preloader &&
               ...
               f("UpdateStatus", (i = { status: e, text: t })),
               (e = i.status),
               (t = i.text),
               m.preloader.html(t),
         ...
         (c.fn.magnificPopup = function (e) {
            ...
            return (
               "string" == typeof e
                  ? "open" === e
                     ? ((t = l ? s.data("magnificPopup") : s[0].magnificPopup),
                       ...
                       (o = t.items
                          ...
                          : ((o = s),
                            ...
                            o.eq(i))),
                       m._openClick({ mfpEl: o }, s, t))
                     : m.isOpen &&
                       m[e].apply(m, Array.prototype.slice.call(arguments, 1))
                  : ((e = c.extend(!0, {}, e)),
                    l ? s.data("magnificPopup", e) : (s[0].magnificPopup = e),
                    m.addGroup(s, e)),
               s
            );
         });
      function C() {
         x && ($.after(x.addClass(b)).detach(), (x = null));
      }
      var b,
         $,
         x,
                     ...
                     s.length
                        ? ((i = s[0].parentNode) &&
                             ...
                             ($ ||
                                ...
                                ($ = u(b)),
                                (b = "mfp-" + b)),
                             (x = s.after($).detach().removeClass(b))),
                          m.updateStatus("ready"))
                        : (m.updateStatus("error", o.tNotFound),
                          (s = c("<div>"))),
                     (e.inlineElement = s)
                  );
               }
      ...
      c.magnificPopup.registerModule(z, {
         ...
         proto: {
            ...
            getAjax: function (s) {
               A && c(document.body).addClass(A), m.updateStatus("loading");
               var e = c.extend(
                  {
                     url: s.src,
         ...
         proto: {
            initZoom: function () {
               ...
               r.enabled &&
                  ...
                  p(a + l, function () {
                     m._allowZoom() && (o(), n && n.remove(), (e = null));
                  }));
            },
            _allowZoom: function () {
            ...
            _getOffset: function (e) {
               ...
               var n = {
                  width: t.width(),
                  height: (l ? t.innerHeight() : t[0].offsetHeight) - s - o,
               };
               return (
                  void 0 === E &&
                     (E =
            ...
            initGallery: function () {
               ...
               (v += " mfp-gallery"),
                  ...
                  p("UpdateStatus" + e, function (e, t) {
                     t.text &&
                        (t.text = _(t.text, m.currItem.index, m.items.length));
                  }),
                  p(y + e, function (e, t, i, o) {
                     var s = m.items.length;
                     i.counter = 1 < s ? _(n.tCounter, o.index, s) : "";
                  }),
            ...
            preloadNearbyImages: function () {
               for (
                  var e = m.st.gallery.preload,
                     ...
                     i = Math.min(e[1], m.items.length),
                     o = 1;
                  o <= (m.direction ? i : t);
                  o++
               )
                  m._preloadItem(m.index + o);
               for (o = 1; o <= (m.direction ? t : i); o++)
                  m._preloadItem(m.index - o);
            },
